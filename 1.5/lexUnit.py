...
class lexUnit(GeneratedsSuper):
    ...
    def __init__(self, status=None, name=None, frame=None, POS=None, frameID=None, incorporatedFE=None, totalAnnotated=None, ID=None, header=None, definition=None, lexeme=None, semType=None, valences=None, subCorpus=None):
        ...
        self.totalAnnotated = _cast(None, totalAnnotated)
    ...
    def factory(*args_, **kwargs_):
        if lexUnit.subclass:
            return lexUnit.subclass(*args_, **kwargs_)
        else:
            return lexUnit(*args_, **kwargs_)
    ...
    def get_valences(self): return self.valences
    def set_valences(self, valences): self.valences = valences
    def get_subCorpus(self): return self.subCorpus
    def set_subCorpus(self, subCorpus): self.subCorpus = subCorpus
    def add_subCorpus(self, value): self.subCorpus.append(value)
    def insert_subCorpus(self, index, value): self.subCorpus[index] = value
    ...
    def get_totalAnnotated(self): return self.totalAnnotated
    def set_totalAnnotated(self, totalAnnotated): self.totalAnnotated = totalAnnotated
    def get_ID(self): return self.ID
    def set_ID(self, ID): self.ID = ID
    def export(self, outfile, level, namespace_='fn:', name_='lexUnit', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        self.exportAttributes(outfile, level, [], namespace_, name_='lexUnit')
        if self.hasContent_():
            outfile.write('>\n')
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='fn:', name_='lexUnit'):
        ...
        if self.totalAnnotated is not None and 'totalAnnotated' not in already_processed:
            already_processed.append('totalAnnotated')
            outfile.write(' totalAnnotated=%s' % (quote_attrib(self.totalAnnotated), ))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.append('ID')
            outfile.write(' ID=%s' % (quote_attrib(self.ID), ))
    def exportChildren(self, outfile, level, namespace_='fn:', name_='lexUnit', fromsubclass_=False):
        if self.header:
        ...
        if self.valences:
            self.valences.export(outfile, level, namespace_, name_='valences')
        for subCorpus_ in self.subCorpus:
            subCorpus_.export(outfile, level, namespace_, name_='subCorpus')
    def hasContent_(self):
        if (
            ...
            self.lexeme or
            self.semType or
            self.valences is not None or
            self.subCorpus
            ):
            return True
        else:
            return False
    def exportLiteral(self, outfile, level, name_='lexUnit'):
        level += 1
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.totalAnnotated is not None and 'totalAnnotated' not in already_processed:
            already_processed.append('totalAnnotated')
            showIndent(outfile, level)
            outfile.write('totalAnnotated = %s,\n' % (self.totalAnnotated,))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.append('ID')
            showIndent(outfile, level)
            outfile.write('ID = %s,\n' % (self.ID,))
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.valences is not None:
            showIndent(outfile, level)
            outfile.write('valences=model_.valencesType(\n')
            self.valences.exportLiteral(outfile, level, name_='valences')
            showIndent(outfile, level)
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('subCorpus=[\n')
        level += 1
        for subCorpus_ in self.subCorpus:
            showIndent(outfile, level)
            outfile.write('model_.subCorpusType(\n')
            subCorpus_.exportLiteral(outfile, level, name_='subCorpusType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        value = attrs.get('totalAnnotated')
        if value is not None and 'totalAnnotated' not in already_processed:
            already_processed.append('totalAnnotated')
            self.totalAnnotated = value
        value = attrs.get('ID')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'valences': 
            obj_ = valencesType.factory()
            obj_.build(child_)
            self.set_valences(obj_)
        elif nodeName_ == 'subCorpus': 
            obj_ = subCorpusType.factory()
            obj_.build(child_)
            self.subCorpus.append(obj_)
# end class lexUnit


class valencesType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, governor=None, FERealization=None, FEGroupRealization=None):
        ...
        if FERealization is None:
            self.FERealization = []
        else:
            self.FERealization = FERealization
        if FEGroupRealization is None:
            self.FEGroupRealization = []
        else:
            self.FEGroupRealization = FEGroupRealization
    def factory(*args_, **kwargs_):
        if valencesType.subclass:
            return valencesType.subclass(*args_, **kwargs_)
        else:
            return valencesType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_governor(self): return self.governor
    def set_governor(self, governor): self.governor = governor
    def add_governor(self, value): self.governor.append(value)
    def insert_governor(self, index, value): self.governor[index] = value
    def get_FERealization(self): return self.FERealization
    def set_FERealization(self, FERealization): self.FERealization = FERealization
    def add_FERealization(self, value): self.FERealization.append(value)
    def insert_FERealization(self, index, value): self.FERealization[index] = value
    def get_FEGroupRealization(self): return self.FEGroupRealization
    def set_FEGroupRealization(self, FEGroupRealization): self.FEGroupRealization = FEGroupRealization
    def add_FEGroupRealization(self, value): self.FEGroupRealization.append(value)
    def insert_FEGroupRealization(self, index, value): self.FEGroupRealization[index] = value
    def export(self, outfile, level, namespace_='fn:', name_='valencesType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        self.exportAttributes(outfile, level, [], namespace_, name_='valencesType')
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, namespace_, name_)
            showIndent(outfile, level)
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='fn:', name_='valencesType'):
        pass
    def exportChildren(self, outfile, level, namespace_='fn:', name_='valencesType', fromsubclass_=False):
        for governor_ in self.governor:
            governor_.export(outfile, level, namespace_, name_='governor')
        for FERealization_ in self.FERealization:
            FERealization_.export(outfile, level, namespace_, name_='FERealization')
        for FEGroupRealization_ in self.FEGroupRealization:
            FEGroupRealization_.export(outfile, level, namespace_, name_='FEGroupRealization')
    def hasContent_(self):
        if (
            self.governor or
            self.FERealization or
            self.FEGroupRealization
            ):
            return True
        else:
            return False
    def exportLiteral(self, outfile, level, name_='valencesType'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('governor=[\n')
        level += 1
        for governor_ in self.governor:
            showIndent(outfile, level)
            outfile.write('model_.governorType(\n')
            governor_.exportLiteral(outfile, level, name_='governorType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('FERealization=[\n')
        level += 1
        for FERealization_ in self.FERealization:
            showIndent(outfile, level)
            outfile.write('model_.FERealizationType(\n')
            FERealization_.exportLiteral(outfile, level, name_='FERealizationType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('FEGroupRealization=[\n')
        level += 1
        for FEGroupRealization_ in self.FEGroupRealization:
            showIndent(outfile, level)
            outfile.write('model_.FEGroupRealizationType(\n')
            FEGroupRealization_.exportLiteral(outfile, level, name_='FEGroupRealizationType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'governor': 
            obj_ = governorType.factory()
            obj_.build(child_)
            self.governor.append(obj_)
        elif nodeName_ == 'FERealization': 
            obj_ = FERealizationType.factory()
            obj_.build(child_)
            self.FERealization.append(obj_)
        elif nodeName_ == 'FEGroupRealization': 
            obj_ = FEGroupRealizationType.factory()
            obj_.build(child_)
            self.FEGroupRealization.append(obj_)
# end class valencesType


class subCorpusType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if subCorpusType.subclass:
            return subCorpusType.subclass(*args_, **kwargs_)
        else:
            return subCorpusType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def get_name(self): return self.name
    def set_name(self, name): self.name = name
    def export(self, outfile, level, namespace_='fn:', name_='subCorpusType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        self.exportAttributes(outfile, level, [], namespace_, name_='subCorpusType')
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, namespace_, name_)
            showIndent(outfile, level)
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='fn:', name_='subCorpusType'):
        if self.name is not None and 'name' not in already_processed:
            already_processed.append('name')
            outfile.write(' name=%s' % (self.gds_format_string(quote_attrib(self.name).encode(ExternalEncoding), input_name='name'), ))
    def exportChildren(self, outfile, level, namespace_='fn:', name_='subCorpusType', fromsubclass_=False):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='subCorpusType'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
...
# end class subCorpusType


class governorType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, lemma=None, type_=None, annoSet=None):
        self.lemma = _cast(None, lemma)
    ...
    def factory(*args_, **kwargs_):
        if governorType.subclass:
            return governorType.subclass(*args_, **kwargs_)
        else:
            return governorType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_annoSet(self): return self.annoSet
    def set_annoSet(self, annoSet): self.annoSet = annoSet
    def add_annoSet(self, value): self.annoSet.append(value)
    def insert_annoSet(self, index, value): self.annoSet[index] = value
    def get_lemma(self): return self.lemma
    def set_lemma(self, lemma): self.lemma = lemma
    def get_type(self): return self.type_
    def set_type(self, type_): self.type_ = type_
    def export(self, outfile, level, namespace_='fn:', name_='governorType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        self.exportAttributes(outfile, level, [], namespace_, name_='governorType')
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, namespace_, name_)
            showIndent(outfile, level)
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='fn:', name_='governorType'):
        if self.lemma is not None and 'lemma' not in already_processed:
            already_processed.append('lemma')
            outfile.write(' lemma=%s' % (self.gds_format_string(quote_attrib(self.lemma).encode(ExternalEncoding), input_name='lemma'), ))
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.append('type_')
            outfile.write(' type=%s' % (self.gds_format_string(quote_attrib(self.type_).encode(ExternalEncoding), input_name='type'), ))
    def exportChildren(self, outfile, level, namespace_='fn:', name_='governorType', fromsubclass_=False):
        for annoSet_ in self.annoSet:
            annoSet_.export(outfile, level, namespace_, name_='annoSet')
    def hasContent_(self):
        if (
            self.annoSet
            ):
            ...
            return False
    def exportLiteral(self, outfile, level, name_='governorType'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('annoSet=[\n')
        level += 1
        for annoSet_ in self.annoSet:
            showIndent(outfile, level)
            outfile.write('model_.annoSetType(\n')
            annoSet_.exportLiteral(outfile, level, name_='annoSetType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
    ...
    def build(self, node):
        ...
        for child in node:
            ...
            self.buildChildren(child, node, nodeName_)
    def buildAttributes(self, node, attrs, already_processed):
        value = attrs.get('lemma')
        if value is not None and 'lemma' not in already_processed:
            already_processed.append('lemma')
            self.lemma = value
        ...
        if value is not None and 'type' not in already_processed:
            ...
            self.type_ = value
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'annoSet': 
            obj_ = annoSetType.factory()
            obj_.build(child_)
            self.annoSet.append(obj_)
# end class governorType


class FERealizationType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if FERealizationType.subclass:
            return FERealizationType.subclass(*args_, **kwargs_)
        else:
            return FERealizationType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='fn:', name_='FERealizationType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        self.exportAttributes(outfile, level, [], namespace_, name_='FERealizationType')
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, namespace_, name_)
            showIndent(outfile, level)
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='fn:', name_='FERealizationType'):
    ...
    def exportChildren(self, outfile, level, namespace_='fn:', name_='FERealizationType', fromsubclass_=False):
        if self.FE:
            self.FE.export(outfile, level, namespace_, name_='FE', )
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='FERealizationType'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.FE is not None:
            showIndent(outfile, level)
            outfile.write('FE=model_.FEValenceType(\n')
            self.FE.exportLiteral(outfile, level, name_='FE')
            showIndent(outfile, level)
            outfile.write('),\n')
        showIndent(outfile, level)
        ...
        for pattern_ in self.pattern:
            ...
            pattern_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class pattern(GeneratedsSuper):
    ...
    factory = staticmethod(factory)
    def get_valenceUnit(self): return self.valenceUnit
    def set_valenceUnit(self, valenceUnit): self.valenceUnit = valenceUnit
    def get_annoSet(self): return self.annoSet
    def set_annoSet(self, annoSet): self.annoSet = annoSet
    def add_annoSet(self, value): self.annoSet.append(value)
    def insert_annoSet(self, index, value): self.annoSet[index] = value
    def get_total(self): return self.total
    def set_total(self, total): self.total = total
    def export(self, outfile, level, namespace_='fn:', name_='pattern', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        self.exportAttributes(outfile, level, [], namespace_, name_='pattern')
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, namespace_, name_)
            showIndent(outfile, level)
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='fn:', name_='pattern'):
        if self.total is not None and 'total' not in already_processed:
            already_processed.append('total')
            outfile.write(' total=%s' % (quote_attrib(self.total), ))
    def exportChildren(self, outfile, level, namespace_='fn:', name_='pattern', fromsubclass_=False):
        if self.valenceUnit:
            self.valenceUnit.export(outfile, level, namespace_, name_='valenceUnit', )
        for annoSet_ in self.annoSet:
            annoSet_.export(outfile, level, namespace_, name_='annoSet')
    def hasContent_(self):
        if (
            self.valenceUnit is not None or
            self.annoSet
            ):
            return True
        else:
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.total is not None and 'total' not in already_processed:
            ...
            outfile.write('total = %s,\n' % (self.total,))
    def exportLiteralChildren(self, outfile, level, name_):
        if self.valenceUnit is not None:
            showIndent(outfile, level)
            outfile.write('valenceUnit=model_.valenceUnitType(\n')
            self.valenceUnit.exportLiteral(outfile, level, name_='valenceUnit')
            showIndent(outfile, level)
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('annoSet=[\n')
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'total' not in already_processed:
            ...
            self.total = value
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'valenceUnit': 
            obj_ = valenceUnitType.factory()
            obj_.build(child_)
            self.set_valenceUnit(obj_)
        elif nodeName_ == 'annoSet': 
            obj_ = annoSetType.factory()
            obj_.build(child_)
            self.annoSet.append(obj_)
# end class pattern
...
class FEGroupRealizationType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, total=None, FE=None, pattern=None):
        self.total = _cast(None, total)
        ...
        if pattern is None:
            ...
            self.pattern = pattern
    def factory(*args_, **kwargs_):
        if FEGroupRealizationType.subclass:
            return FEGroupRealizationType.subclass(*args_, **kwargs_)
        else:
            return FEGroupRealizationType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_FE(self): return self.FE
    def set_FE(self, FE): self.FE = FE
    ...
    def get_total(self): return self.total
    def set_total(self, total): self.total = total
    def export(self, outfile, level, namespace_='fn:', name_='FEGroupRealizationType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        self.exportAttributes(outfile, level, [], namespace_, name_='FEGroupRealizationType')
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, namespace_, name_)
            showIndent(outfile, level)
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='fn:', name_='FEGroupRealizationType'):
        if self.total is not None and 'total' not in already_processed:
            already_processed.append('total')
            outfile.write(' total=%s' % (quote_attrib(self.total), ))
    def exportChildren(self, outfile, level, namespace_='fn:', name_='FEGroupRealizationType', fromsubclass_=False):
        for FE_ in self.FE:
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='FEGroupRealizationType'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for FE_ in self.FE:
            showIndent(outfile, level)
            outfile.write('model_.FEValenceType(\n')
            FE_.exportLiteral(outfile, level, name_='FEValenceType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'FE': 
            ...
            obj_.build(child_)
            self.pattern.append(obj_)
# end class FEGroupRealizationType


class annoSetType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if annoSetType.subclass:
            return annoSetType.subclass(*args_, **kwargs_)
        else:
            return annoSetType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ID(self): return self.ID
    def set_ID(self, ID): self.ID = ID
    def get_valueOf_(self): return self.valueOf_
    def set_valueOf_(self, valueOf_): self.valueOf_ = valueOf_
    def export(self, outfile, level, namespace_='fn:', name_='annoSetType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        self.exportAttributes(outfile, level, [], namespace_, name_='annoSetType')
        if self.hasContent_():
            outfile.write('>')
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='fn:', name_='annoSetType'):
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.append('ID')
            outfile.write(' ID=%s' % (quote_attrib(self.ID), ))
    def exportChildren(self, outfile, level, namespace_='fn:', name_='annoSetType', fromsubclass_=False):
        pass
    def hasContent_(self):
        if (
            self.valueOf_
            ...
            return False
    def exportLiteral(self, outfile, level, name_='annoSetType'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class annoSetType


class FEValenceType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, name=None, valueOf_=None):
        ...
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
        if FEValenceType.subclass:
            return FEValenceType.subclass(*args_, **kwargs_)
        else:
            return FEValenceType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_name(self): return self.name
    def set_name(self, name): self.name = name
    def get_valueOf_(self): return self.valueOf_
    def set_valueOf_(self, valueOf_): self.valueOf_ = valueOf_
    def export(self, outfile, level, namespace_='fn:', name_='FEValenceType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        self.exportAttributes(outfile, level, [], namespace_, name_='FEValenceType')
        if self.hasContent_():
            outfile.write('>')
            outfile.write(self.valueOf_)
            self.exportChildren(outfile, level + 1, namespace_, name_)
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='fn:', name_='FEValenceType'):
        if self.name is not None and 'name' not in already_processed:
            already_processed.append('name')
            outfile.write(' name=%s' % (self.gds_format_string(quote_attrib(self.name).encode(ExternalEncoding), input_name='name'), ))
    def exportChildren(self, outfile, level, namespace_='fn:', name_='FEValenceType', fromsubclass_=False):
        pass
    def hasContent_(self):
        if (
            self.valueOf_
            ...
            return False
    def exportLiteral(self, outfile, level, name_='FEValenceType'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class FEValenceType


class valenceUnitType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, GF=None, FE=None, PT=None, valueOf_=None):
        self.GF = _cast(None, GF)
        self.FE = _cast(None, FE)
        self.PT = _cast(None, PT)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
        if valenceUnitType.subclass:
            return valenceUnitType.subclass(*args_, **kwargs_)
        else:
            return valenceUnitType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_GF(self): return self.GF
    def set_GF(self, GF): self.GF = GF
    def get_FE(self): return self.FE
    def set_FE(self, FE): self.FE = FE
    ...
    def get_valueOf_(self): return self.valueOf_
    def set_valueOf_(self, valueOf_): self.valueOf_ = valueOf_
    def export(self, outfile, level, namespace_='fn:', name_='valenceUnitType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        self.exportAttributes(outfile, level, [], namespace_, name_='valenceUnitType')
        if self.hasContent_():
            outfile.write('>')
            outfile.write(self.valueOf_)
            self.exportChildren(outfile, level + 1, namespace_, name_)
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='fn:', name_='valenceUnitType'):
        if self.GF is not None and 'GF' not in already_processed:
            already_processed.append('GF')
            outfile.write(' GF=%s' % (self.gds_format_string(quote_attrib(self.GF).encode(ExternalEncoding), input_name='GF'), ))
        if self.FE is not None and 'FE' not in already_processed:
            already_processed.append('FE')
            outfile.write(' FE=%s' % (self.gds_format_string(quote_attrib(self.FE).encode(ExternalEncoding), input_name='FE'), ))
        if self.PT is not None and 'PT' not in already_processed:
            already_processed.append('PT')
            outfile.write(' PT=%s' % (self.gds_format_string(quote_attrib(self.PT).encode(ExternalEncoding), input_name='PT'), ))
    def exportChildren(self, outfile, level, namespace_='fn:', name_='valenceUnitType', fromsubclass_=False):
        pass
    def hasContent_(self):
        if (
            self.valueOf_
            ...
            return False
    def exportLiteral(self, outfile, level, name_='valenceUnitType'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def buildAttributes(self, node, attrs, already_processed):
        value = attrs.get('GF')
        if value is not None and 'GF' not in already_processed:
            already_processed.append('GF')
            self.GF = value
        value = attrs.get('FE')
        if value is not None and 'FE' not in already_processed:
            already_processed.append('FE')
            self.FE = value
        value = attrs.get('PT')
        if value is not None and 'PT' not in already_processed:
            already_processed.append('PT')
            self.PT = value
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class valenceUnitType
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="lexUnit",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from lexUnit import *\n\n')
    sys.stdout.write('import lexUnit as model_\n\n')
