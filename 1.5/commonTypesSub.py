...
#
# Generated Fri Apr 15 15:55:47 2011 by generateDS.py version 2.4c.
#
...
def parseLiteral(inFilename):
    ...
    sys.stdout.write('rootObj = model_.lexemeType(\n')
    rootObj.exportLiteral(sys.stdout, 0, name_="lexemeType")
    sys.stdout.write(')\n')
    return rootObj
