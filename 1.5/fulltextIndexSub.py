...
class fulltextIndexSub(supermod.fulltextIndex):
    def __init__(self, corpus=None):
        super(fulltextIndexSub, self).__init__(corpus, )
supermod.fulltextIndex.subclass = fulltextIndexSub
# end class fulltextIndexSub
...
def parse(inFilename):
    ...
    if rootClass is None:
        ...
        rootClass = supermod.fulltextIndex
...
def parseLiteral(inFilename):
    ...
    sys.stdout.write('rootObj = model_.fulltextIndex(\n')
    rootObj.exportLiteral(sys.stdout, 0, name_="fulltextIndex")
    sys.stdout.write(')\n')
    return rootObj
