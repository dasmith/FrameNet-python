...
class fullTextAnnotationSub(supermod.fullTextAnnotation):
    def __init__(self, header=None, sentence=None):
        super(fullTextAnnotationSub, self).__init__(header, sentence, )
supermod.fullTextAnnotation.subclass = fullTextAnnotationSub
# end class fullTextAnnotationSub
...
def parse(inFilename):
    ...
    if rootClass is None:
        ...
        rootClass = supermod.fullTextAnnotation
...
def parseLiteral(inFilename):
    ...
    sys.stdout.write('rootObj = model_.fullTextAnnotation(\n')
    rootObj.exportLiteral(sys.stdout, 0, name_="fullTextAnnotation")
    sys.stdout.write(')\n')
    return rootObj
